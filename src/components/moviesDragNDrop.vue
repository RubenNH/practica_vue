<template>
  <b-container fluid>
    <b-row>
      <DragNDropCreateMovie :genres="genres" :genresToSend="genresToSend" :movies="movies"
        @movieRegistered="onMovieRegistered" />
            ...
            <b-row>
              <b-col cols="12" md="4">
                <b-form-group label="Nombre">
                  <b-form-input v-model="seachForm.name" required pattern="[A-Za-z]+" />
                </b-form-group>
              </b-col>
              <b-col cols="12" md="4">
                <b-form-group label="Director">
                  <b-form-input v-model="seachForm.director" required pattern="[A-Za-z]+" />
                </b-form-group>
              </b-col>
              <b-col cols="12" md="4">
            ...
            <b-row>
              ...
              <b-col cols="12" md="4">
                <b-form-group label="Año Inicio">
                  <b-form-input v-model="seachForm.yearIni" type="number" required></b-form-input>
                </b-form-group>
              </b-col>
              <b-col cols="12" md="4">
                <b-form-group label="Año Final">
                  <b-form-input v-model="seachForm.yearEnd" type="number" required></b-form-input>
                </b-form-group>
              </b-col>
...
import DragNDropCreateMovie from './DragNDropCreateMovie.vue';
export default {
  components: { DragNDropCreateMovie },
  data() {
    return {
      genres: [],
      genresToSend: [],
